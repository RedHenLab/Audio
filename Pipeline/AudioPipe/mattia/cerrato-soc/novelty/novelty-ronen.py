# Original implementation found at https://github.com/adobe-research/audio-retargeting/blob/master/radiotool/radiotool/algorithms/novelty.py
# Debugged and modified by Mattia Cerrato during August 2015
...
def naive_peaks(vec, k=33):
    ...
    print "kurtosis of the unsmoothed vector:" +str(scipy.stats.kurtosis(vec))
    print "kurtosis of the smoothed vector:" +str(scipy.stats.kurtosis(a))
...
if __name__ == '__main__':
    ...
    print novelty(song, k=int(sys.argv[2]))
