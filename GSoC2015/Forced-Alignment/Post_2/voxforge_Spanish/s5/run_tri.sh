...
steps/decode.sh  \
   exp/tri3b/graph data/test exp/tri3b_mmi/decode2 || exit 1;
...
#   data/train data/lang exp/tri3b_ali exp/dubm3b exp/tri3b_denlats \
#  exp/tri3b_fmmi_b || exit 1;

#for iter in 3 4 5 6 7 8; do
# steps/decode_fmmi.sh  \
#    exp/tri3b/graph data/test exp/tri3b_fmmi_b/decode_it$iter &
#done

#steps/train_mmi_fmmi.sh  \
#   exp/tri3b_ali exp/dubm3b exp/tri3b_denlats \
#  exp/tri3b_fmmi_c || exit 1;

#for iter in 3 4 5 6 7 8; do
# steps/decode_fmmi.sh  \
#     exp/tri3b/graph data/test exp/tri3b_fmmi_c/decode_it$iter &
#done
